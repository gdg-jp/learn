...
- `.claat/fix-claat-codespans.py` — post-processor that escapes raw HTML inside inline `<code>` spans, restores `Note:` / `Tip:` callouts, and enhances generated code blocks with copy/theme controls. Run automatically by `make claat`.
