...
<p style="font-size: 38px; font-weight: 700; margin: 0 0 26px;">
  <a href="https://gdgs.jp/lyria-hands-on">https://gdgs.jp/lyria-hands-on</a>
</p>
...
## Media Studio が使えない場合

Google Cloud の Lyria が使えない人だけ、Gemini アプリで進めます

<div class="container" style="align-items: center; gap: 40px;">
...
2. 入力欄左の `+` を押します
3. `音楽` を選びます
4. 以降のプロンプトを Gemini に貼り付けます

</div>

<div class="col" style="flex: 1 1 52%;">

<div style="border: 2px solid var(--gdg-red); border-radius: 8px; padding: 22px; color: var(--gdg-red); font-weight: 700; font-size: 24px; line-height: 1.45;">
Caution: Media Studio が開けた方は、このスライドをスキップしてください
</div>

<div style="margin-top: 24px; text-align: center;">
  <img src="../img/gemini_google_com_qr_code.png" alt="Gemini アプリの QR コード" style="width: 230px; background: #fff; padding: 18px; border: 2px solid var(--gdg-line); border-radius: 8px;">
  <p style="margin: 10px 0 0; font-size: 18px; font-weight: 700;">Gemini アプリを開く</p>
</div>
...
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 28px; align-items: end;">
  <div style="text-align: center;">
    <img src="../img/screenshot_00_gemini_app_1.png" alt="Gemini アプリで入力欄左の追加ボタンを押す" style="height: 500px; max-width: 100%; object-fit: contain; border: 1px solid var(--gdg-line); border-radius: 8px;">
    <p style="margin: 10px 0 0; font-size: 20px; font-weight: 700;">1. + を押す</p>
  </div>
  <div style="text-align: center;">
    <img src="../img/screenshot_00_gemini_app_2.png" alt="Gemini アプリで音楽生成を選ぶ" style="height: 500px; max-width: 100%; object-fit: contain; border: 1px solid var(--gdg-line); border-radius: 8px;">
    <p style="margin: 10px 0 0; font-size: 20px; font-weight: 700;">2. 音楽を選ぶ</p>
  </div>
</div>
